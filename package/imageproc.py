...
def getImageDensity(side):
    img = loadImg('C:\\Users\\parme\\OneDrive\\Desktop\\TEST_Proj_Final' + side + '.jpg')
    baseImg = loadImg('C:\\Users\\parme\\OneDrive\\Desktop\\TEST_Proj_Final\\images\\base' + side + '.jpg')
